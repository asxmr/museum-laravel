...
@section('page-header')
    <h1 class="admin-page-title">FAQ Categorieën</h1>
    <p class="admin-page-subtitle">
        Beheer de structuur van je veelgestelde vragen door categorieën toe te voegen, te ordenen en te bewerken.
    </p>
@endsection
...
<style>
    ...
    .admin-table thead {
        background: linear-gradient(120deg, rgba(123, 27, 56, 0.2), rgba(15, 15, 25, 0.95));
    }
    ...
    .admin-table td.admin-table-muted {
...
<div class="admin-table-header">
    ...
    <a href="{{ route('admin.faq-categories.create') }}" class="btn-admin-primary">
        Nieuwe categorie
    </a>
</div>
