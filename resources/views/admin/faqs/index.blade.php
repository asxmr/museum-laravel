...
@section('page-header')
    <h1 class="admin-page-title">FAQ Vragen</h1>
    <p class="admin-page-subtitle">
        Beheer alle veelgestelde vragen, hun categorieën en zichtbaarheid op de publieke FAQ-pagina.
    </p>
@endsection
                    ...
                    <td>
                        <div class="admin-table-actions">
                            ...
                            <form action="{{ route('admin.faqs.destroy', $faq) }}"
                                  method="POST"
                                  onsubmit="return confirm('Ben je zeker dat je deze vraag wilt verwijderen?');">
                                @csrf
                                @method('DELETE')
